...
namespace ATIM_GUI._05_XYZ
{
    public partial class Window_XYZ_manuell_drive : Form
    {
        ...
        private XYZ_table myTable = null;

        public Window_XYZ_manuell_drive(XYZ_table callingTable)
        {
        ...
        private string path_Init_File = @"C:\Users\schmidm\Desktop\ATIM_Software\0_Initialisation_Files\Predefined_Positions.ini";
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    else
                    {
                        ...
                        defined_Positions.Add(new XYZA_Position()
                        {
                            ...
                            X_Position = Convert.ToDecimal(line.Substring(index_x + 2, index_y - index_x - 2)),
                            Y_Position = Convert.ToDecimal(line.Substring(index_y + 2, index_z - index_y - 2)),
                            Z_Position = Convert.ToDecimal(line.Substring(index_z + 2, index_a - index_z - 2)),
                            Angle = Convert.ToDecimal(line.Substring(index_a + 2)),
                    }
                        );
                    }
                }
