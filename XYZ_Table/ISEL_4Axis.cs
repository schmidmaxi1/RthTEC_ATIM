...
namespace XYZ_Table
{
    public partial class ISEL_4Axis : UserControl, I_XYZ
    {
        ...
        public decimal Grenze_X_pos { get; set; } = 260;
        ...
        public ISEL_4Axis(Form callingForm, int x, int y)
        {
            InitializeComponent();
        ...
        public void Initialisieren()
        {
            ...
            MyISEL.SendMessage_withAnswer("@08");
        }
        ...
        public void ReferenceDrive()
        {
            ...
            MyISEL.SendMessage_withoutAnswer("@0R8");
            MyISEL.Check_if_position_is_reached_REFDrive();
        ...
        public bool Move2Position(decimal xKoordinate, decimal yKoordinate, decimal zKoordinate, decimal winkel)
        {
            ...
            if (this.CheckIfPointAllowed(xKoordinate, yKoordinate, zKoordinate, winkel))
            {
                ...
                MyISEL.SendMessage_withoutAnswer("@0M " + schritte_x.ToString() + "," + X_ges_schnell.ToString() + ","
        ...
        public bool MoveADistance(decimal xWeg, decimal yWeg, decimal zWeg, decimal winkel)
        {
            ...
            if (this.CheckIfPointAllowed(Akt_x_Koordinate + xWeg, Akt_y_Koordinate + yWeg, Akt_z_Koordinate + zWeg, winkel + Akt_Winkel))
            {
                ...
                MyISEL.SendMessage_withoutAnswer("@0A " + schritte_x.ToString() + "," + X_ges_schnell.ToString() + ","
                                                      + schritte_y.ToString() + "," + Y_ges_schnell.ToString() + ","
                                                      + schritte_z.ToString() + ',' + Z_ges_schnell.ToString() + ","
                                                      + schritte_a.ToString() + ',' + A_ges_schnell.ToString());
        ...
        public void Position_aktualisiern()
        {
            ...
            if (MyISEL.Antwort.Length == 25)
            {
                ...
                String position_W_Teil = MyISEL.Antwort.Substring(19, 6);
        ...
        public void AdjusteAxisDerections()
        {
            ...
            MyISEL.SendMessage_withAnswer("@0IR12");
            //y-Achse & z-Achse umkehren
            MyISEL.SendMessage_withAnswer("@0ID14");
        }
